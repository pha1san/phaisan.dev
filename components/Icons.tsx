...
import type { IconifyIconHTMLElement, IconifyIconProperties } from "iconify-icon";
 ...
 * React component
 */
export const Icon = React.forwardRef((props: IconifyIconProps, ref: React.ForwardedRef<IconifyIconHTMLElement>) => {
