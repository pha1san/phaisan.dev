...
const SiteHead: FC<{ title: string }> = ({ title }) => (
  <Head>
    <title>{title}</title>
    <meta name="title" content="Phaisan Uyarnontruk - Frontend Developer" />
    ...
    <meta property="og:title" content="Phaisan Uyarnontruk - Frontend Developer" />
    ...
    <meta property="twitter:title" content="Phaisan Uyarnontruk - Frontend Developer" />
